import { NAVBAR_LINKS, TRANSFORMATIONS_LINKS } from "@/constants";
import { cn } from "@/lib/cn";
import { Sparkles } from "lucide-react";
import Link from "next/link";

export default function StartHeroSection() {
  const features = TRANSFORMATIONS_LINKS;
  return (
    <section className="flex justify-center items-center">
      <div className="flex flex-col items-center bg-gradient-to-br from-[#8a2be2] to-[#4682b4] shadow-lg p-6 md:p-8 rounded-2xl w-full max-w-5xl text-center">
